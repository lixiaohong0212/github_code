...
class TestTClient implements TestTIf {
  ...
  public function recv_getdata()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\TestT_getdata_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new TestT_getdata_result();
...
class TestT_getdata_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TestT_getdata_args');
    if ($this->arg !== null) {
...
class TestT_getdata_result {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TestT_getdata_result');
